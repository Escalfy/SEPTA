...
os.chdir('/Users/Micke/Desktop/EHR')
...
del df['Unnamed: 0']
del df['F-Type']
############ Kap-20 not working to creat 6 dayaframs 
...
FIGURE = [scatter_plot01(),scatter_plot02(),scatter_plot03(),scatter_plot04(),
          scatter_plot05(),scatter_plot06()]
...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            html.Div([
                html.P('CLICK a feature in the bottom graph to select it in the table to the right.'),
                html.P('HOVER over points to see exact value.')
    ...
    html.Div([
            html.H2('Serious Adverse Drug Event Identified',
                style={
                    'position': 'relative',
                    'top': '550px',
                    'right': '80px',
   ...
   #############
     ...
     html.Div([
        html.Div([
            ...
            html.Button('Complete', id='complete_button'),
     ...
     html.Div([
      html.Div([
        dcc.Dropdown(
            id='drop',
            options=[
                    {'label': 'Patient Case 01', 'value': 'C001'},
...
def survival_graph (identifier):
    ...
    return {
        ...
        'layout':  go.Layout(
                ...
                showlegend = True, 
                title= "<b>Steven Johnson Syndrome Survival Analysis</b>", 
...
def featuresgrapher(drop_value):
    ...
    elif drop_value == 'C002':
        return scatter_plot02(drop_value)
    elif drop_value == 'C003':
        return scatter_plot03(drop_value)
    elif drop_value == 'C004':
        return scatter_plot04(drop_value)
    elif drop_value == 'C005':
        return scatter_plot05(drop_value)
    elif drop_value == 'C006':
        return scatter_plot06(drop_value)
